"""Django settings for geo_platform project.
...
WSGI_APPLICATION = "geo_platform.wsgi.application"

# https://docs.djangoproject.com/en/4.0/ref/settings/#root-urlconf
ROOT_URLCONF = "geo_platform.urls"
...
INSTALLED_APPS = [
    ...
    "geo_platform.apps.users",
    "geo_platform.apps.aoi",
]
...
# Limits
GEOMETRIES_LIMIT: Final[int] = 1_000
